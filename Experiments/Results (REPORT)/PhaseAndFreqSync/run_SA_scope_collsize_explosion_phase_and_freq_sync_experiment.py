...
def main():
    collsizes = [1600, 3200, 6400, 12800] # 400, 800
    ...
    for collSize_val_ind, collSize_val in enumerate(collsizes):
        ...
        # Global SA scope:
        assignNonDefaultHyperparameters(collsize=collSize_val, k_ss=10000000, d_ss=0, adj_phis=1, adj_omegas=1, alphas=0.2, betas=0.7)
