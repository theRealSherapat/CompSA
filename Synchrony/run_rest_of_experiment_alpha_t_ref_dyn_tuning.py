...
def main():
    ...
    assignNonDefaultHyperparameters(collsize=slow_collsize, trefperc=0.05, alpha=0.01, phaseadj=0, beta=0, freqadj=0)
    runNumberOfSimulationRuns(sampSize)
    
    assignNonDefaultHyperparameters(collsize=slow_collsize, trefperc=0.05, alpha=0.1, phaseadj=0, beta=0, freqadj=0)
    runNumberOfSimulationRuns(sampSize)
    
    assignNonDefaultHyperparameters(collsize=slow_collsize, trefperc=0.05, alpha=0.2, phaseadj=0, beta=0, freqadj=0)
    runNumberOfSimulationRuns(sampSize)
    
    assignNonDefaultHyperparameters(collsize=slow_collsize, trefperc=0.05, alpha=0.4, phaseadj=0, beta=0, freqadj=0)
    runNumberOfSimulationRuns(sampSize)
    
    assignNonDefaultHyperparameters(collsize=slow_collsize, trefperc=0.05, alpha=0.8, phaseadj=0, beta=0, freqadj=0)
    runNumberOfSimulationRuns(sampSize)
