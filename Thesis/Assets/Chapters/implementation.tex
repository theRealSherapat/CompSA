...
\label{sec:developed_system}
	...
	\subsubsection{Audible to human simulator-observer}
		...
		Using the music-making system and digital synthesizer LMMS, and a string-instrument LMMS-plugin from DSK Music (fotnote m/ link https://www.dskmusic.com/dsk-world-stringz-updated/), some musical tones I thought sounded harmonious when played together were reproduced and recorded with a digital harp-instrument. The musical tones reproduced were some of the ones perceived in the intro of Pogo's song ``Strangerous.'' (fotnote?)
