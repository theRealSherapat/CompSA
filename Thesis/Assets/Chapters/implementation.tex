...
\label{sec:developed_system}
	...
	\subsubsection{In the simulator}
	...
	\besk{Om Fire-signal-utvikling}
	Started with a recorded guitar-pluck.
	Ended up with a firing-sound with a high enough attack (max amplitude), short sustain, and decay so fast (by using effect 'Fade Out') that the firing-sound would not be longer than around 880ms. This I did in Audacity \inkl{Screenshots/PDF}.
