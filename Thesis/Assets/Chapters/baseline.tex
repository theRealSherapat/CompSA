...
Hence, in terms of oscillator-/robot-frequencies, we have a harmonically synchronized robot-collective if

\begin{equation}\label{synced_freqs}
\omega_i \in \Omega_{legal}(\omega_0) , \forall i ,
\end{equation}

where we then say all agents in the robot-collective have \textit{legal} frequencies.
