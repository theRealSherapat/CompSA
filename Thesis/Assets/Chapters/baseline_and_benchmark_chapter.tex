...
\besk{Mellomkapittel om K. Nymoens approach til fase-\&frekvens-synk. Her presenterer jeg baselinen/benchmarken jeg har brukt mesteparten av masterjobbings-tiden på å etterlikne/implementere i Unity}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.65\linewidth]{Assets/Figures/PhaseErrorFunction.pdf}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.65\linewidth]{Assets/Figures/rho_n.pdf}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.65\linewidth]{Assets/Figures/all_possible_H_n_values.pdf}
