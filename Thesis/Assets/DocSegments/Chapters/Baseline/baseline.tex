...
\label{chap:baseline}
\besk{Mellomkapittel om K. Nymoens approach og teori \cite{nymoen_synch}. Her presenterer jeg teoriene og metodene jeg har brukt mesteparten av masterjobbings-tiden i starten på å implementere og teste i Unity}
