...
\label{sec:nymoen_freq_updates}
	...
	This they managed to do by as mentioned and amongs other measures implementing an aspect of \textit{self awareness} in terms of a \textit{synchrony self assessment} $s(n)$ given ``fire'' event $n$, representing how much or out of sync an individual robot is.
