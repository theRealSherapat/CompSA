\setcounter{secnumdepth}{3} % to allow for deeper chapters/sections with subsections etc.
\everymath{\displaystyle} % to not have to write \displaystyle every time I use a summation symbol in an equation model/array.
\captionsetup[algorithm]{labelsep=colon} % to get colons after the bold-face "Algorithm"-headlines.

\def \hfillx {\hspace*{-\textwidth} \hfill} % to get tables next to each other



% Headers (in Chapters, Sections etc.)
